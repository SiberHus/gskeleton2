...
jQuery.fn.inputEmail = function()
{
		return this.each (function()
			{
				jQuery(this).inputValue({allow:'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@_.0123456789,;'});
			}
		);		
};

jQuery.fn.inputTime12 = function()
{
		return this.each (function()
			{
				jQuery(this).inputValue({allow:'9876543210:APMapm'});
			}
		);
};
jQuery.fn.inputTime24 = function()
{
		return this.each (function()
			{
...
jQuery.fn.inputNumeral = function()
{
		return this.each (function()
			{
				jQuery(this).inputValue({allow:'9876543210'});
