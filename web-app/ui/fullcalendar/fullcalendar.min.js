...
w()&&k()},0)}var O=this,ra=o(O).addClass("fc"),ka,R=o("<div class='fc-content "+g+"-dashboard-content' style='position:relative'/>").prependTo(O),va,Fa=0,N=0,L=new Date,Aa,x,U={},wa;a.isRTL&&ra.addClass("fc-rtl");a.theme&&ra.addClass("ui-dashboard");Cb(L,a.year,a.month,a.date);var P=[],la,A,aa=0,Z={render:function(){ga();G();M();k()},changeView:n,getView:function(){return x},getDate:function(){return L},option:function(e,j){if(j===K)return a[e];if(e=="height"||e=="contentHeight"||e=="aspectRatio"){a[e]=
