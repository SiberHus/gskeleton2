	...
	__pickers[id] =
	{
		...
		initialize: function( id )
		{
			...
			options = jQuery.extend(true,{},options||{});
		  	...
		  	this.inp = $('#'+id);
		  	this.div = $( '<div class="AnyTime-win AnyTime-pkr ui-dashboard ui-dashboard-content ui-corner-all" style="width:0;height:0" id="' + this.id + '" aria-live="off"/>' );
		    this.inp.after(this.div);
		  	this.wMinW = this.div.outerWidth(!$.browser.safari);
		  	this.wMinH = this.div.AnyTime_height(true);
		  	this.hTitle = $( '<h5 class="AnyTime-hdr ui-dashboard-header ui-corner-top"/>' );
		...
		askOffset: function( event )
		{
		    if ( ! this.oDiv )
		    {
		      ...
		      this.oDiv = $('<div class="AnyTime-win AnyTime-off-selector ui-dashboard ui-dashboard-content ui-corner-all" style="position:absolute" />');
		      this.div.append(this.oDiv);
		
		      // the order here (HDR,BODY,XDIV,TITLE) is important for width calcluation:
		      var title = $('<h5 class="AnyTime-hdr AnyTime-hdr-off-selector ui-dashboard-header ui-corner-top" />');
		...
		askYear: function( event )
		{
		    if ( ! this.yDiv )
		    {
		      ...
		      this.yDiv = $('<div class="AnyTime-win AnyTime-yr-selector ui-dashboard ui-dashboard-content ui-corner-all" style="position:absolute" />');
		      this.div.append(this.yDiv);
		
		      var title = $('<h5 class="AnyTime-hdr AnyTime-hdr-yr-selector ui-dashboard-header ui-corner-top" />');
