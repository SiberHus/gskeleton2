	...
	<body>
		...
		<div class="body">
				...
				<table>
					<thead class="ui-widget-header">
						<tr>
							...
							<g:sortableColumn property="name" title="Name" titleKey="faqCategory.name" params="${params }"/>
							<g:sortableColumn property="description" title="Description" titleKey="faqCategory.description" params="${params }"/>
						</tr>
					</thead>
					<tbody>
			...
			<div class="paginateButtons">
				...
				(<span id='resultTotals'>${session['faqCategory.count']}</span>)
			</div>
		</div>
	</body>
</html>
